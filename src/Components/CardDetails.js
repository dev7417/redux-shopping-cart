              ...
              <Table>
                <tr>
                  ...
                  <td>
                    ...
                    <p><strong>Rating:</strong> <span style={{ background: 'green', color: '#fff', padding: '2px 5px', borderRadius: '5px', fontSize: '20px' }}><i className="fa fa-star">3.5</i></span> </p>
                    ...
                    <p><strong>Remove</strong><span style={{ backgroundColor: 'red', color: '#fff', padding: '2px 2px', borderRadius: '5px', margin: '0px 5px', cursor: 'pointer' }}><i className="fa fa-times-circle"></i></span></p>
                  </td>
                </tr>
              </Table>
            </div>
